...
class Next3screen extends StatefulWidget {
  const Next3screen({super.key});

  @override
  State<Next3screen> createState() => _Next3screenState();
}

class _Next3screenState extends State<Next3screen> {
  @override
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Image(image: AssetImage("images/i.png")),
          SizedBox(height: 9,),
          Padding(
